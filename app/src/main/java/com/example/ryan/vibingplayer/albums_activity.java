...
public class albums_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //The boolean from the currently_playing_activity that signifies if a song is currently playing, so the user can press the currently playing button on the menu.
        isSongPlaying = getIntent().getBooleanExtra("weHaveASongPlaying",false);
        //The boolean form From album_songs_list activity that may have a currently playing song when the album_songs_activity calls this activity(still knowing their is a now playing song.)
        isSongPlaying2 = getIntent().getBooleanExtra("album_songs_activity_song_boolean",false);

        //knowing which album the user is currently looking on, so if the user is trying to return to the album_songs_activity, the button can take them back to the exact album. This is from the album_songs_activity class.
        pickedAlbumyet = getIntent().getBooleanExtra("album_songs_picked_album_boolean",false);

        //Same concept in the above varabile, just this is the curretnly_playing_activity. Again, just to be sure the user can come back to the album_songs_activity to look at songs if they skip over activites..i.e...if a user clicks the menu buttons albums to currently playing, and then back to albums.
        ...
        // Setting an onClick listener. Also, sending a message of what album was chose to the other activity. At the moment, I did not know how to send an ArrayList<songs_class> over intents.
        jColeAlbumView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Use the songs_class in the J Cole Album

                message = "It is J. Cole";

                Intent intent = new Intent(albums_activity.this, album_songs_activity.class);
        ...
        dooWopsAlbumView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Use the songs_class in the doo Wops Album
        ...
        loveInTheFutureAlbumView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Use the songs_class in the John Legend Album
        ...
        storiesAlbumView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Use the songs_class in the Avicii Album.
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_album_activity_layout_album_songs_button:
                ...
                if(!pickedAlbumyet2 && !pickedAlbumyet){
                    ...
                    Intent openActivity= new Intent(albums_activity.this, album_songs_activity.class);
            ...
            case R.id.menu_albums_activity_layout_currently_playing_button:
                if(!isSongPlaying && !isSongPlaying2){
                    ...
                    Intent openActivity= new Intent(albums_activity.this, currently_playing_activity.class);
